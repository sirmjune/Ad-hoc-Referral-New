...
<head>
    <!--=============== basic  ===============-->
    <meta charset="UTF-8">
    <title>Contact - Ad-hoc Referral</title>
    <meta name="viewport"
    ...
    <div id="wrapper">
        <div class="content-holder elem scale-bg2 transition3">
            <div class="content">
                ...
                <div class="wrapper-inner">
                    <div class="container">
                        ...
                        <div class="blog-text">
                            ...
                            <p>AD-HOC REFERRAL ("us", "we", or "our") operates the AD MED mobile application (the "Service").</p>

                            <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy  for AD-HOC REFERRAL is created with the help of the <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">Free Privacy Policy Generator</a>.</p>
                            ...
                            <p>AD-HOC REFERRAL uses the collected data for various purposes:</p>
                            <ul>
                            ...
                            <p>If you are located outside Uganda and choose to provide information to us, please note that we transfer the data, including Personal Data, to Uganda and process it there.</p>
                            <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that transfer.</p>
                            <p>AD-HOC REFERRAL will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

                            <h2>Disclosure Of Data</h2>

                            <h3>Legal Requirements</h3>
                            <p>AD-HOC REFERRAL may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                            <ul>
                                <li>To comply with a legal obligation</li>
                                <li>To protect and defend the rights or property of AD-HOC REFERRAL</li>
                            ...
                            <ul>
                                <li>By email: info@ad-hoc-referral.com</li>
                ...
                <!-- parallax column   -->
                <div class="img-wrap">
                    <div class="bg" data-top-bottom="transform: translateY(300px);"
                         data-bottom-top="transform: translateY(-300px);">

                        <div class="col-md-6 sli-one" style="padding: 15px">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d997.4354392250614!2d32.61209582916506!3d0.3549543410630787!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMMKwMjEnMTcuOCJOIDMywrAzNic0NS41IkU!5e0!3m2!1sen!2sus!4v1554912931713!5m2!1sen!2sus"
                                    width="500" height="735" frameborder="0" style="border:0" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
                <!-- parallax column end   -->
                ...
                <footer>
                    <div class="footer-inner">
                        <div class="row">
                            <!--                                    <div class="col-md-5">-->
                            <!--                                        <a class="footer-logo ajax" href="index.html"><img src="/resources/images/footer-logo.png" alt=""></a>-->
                            <!--                                    </div>-->
                            <div class="col-md-3">
                                <div class="footer-adress">
                                            <span>Tusky's Building Level 2,<br/>
                                                Plot 1615, Kira Road,<br/>
                                                Ntinda - Kampala, Central Region.<br/>
                                                P.O.Box 2063 Kampala (U)</span>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <ul class="footer-contact">
                                    <li>+256 (706) 414 199</li>
                                    <li><a href="#">info@ad-hoc-referral.com</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <p> &#169; Ad-hoc Referral 2018. All rights reserved. </p>
                            </div>
                        </div>
                    </div>
