                        ...
                        <div class="swiper-container" id="horizontal-slider" data-mwc="1" data-mwa="0">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="slide-title-holder">
                                        <div class="slide-title">
                                            <h3 class="transition">  <a class="ajax transition2" href="#">Increase your referral options.</a>  </h3>
                                            <h4>Take control of your referral destination and medical assistant with efficient technology at your convenience.</h4>
                                        </div>
                                    </div>
                                </div>
                                <!--=============== 2 ===============-->	
                                <div class="swiper-slide">
                                    ...
                                    <div class="slide-title-holder">
                                        <div class="slide-title">
                                            <h3 class="transition">  <a class="ajax transition2" href="#">A you a medical professional?</a>  </h3>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="slide-title-holder">
                                        <div class="slide-title">
                                            <h3 class="transition">  <a class="ajax transition2" href="#">Streamline reach with referrals network-wide. </a>  </h3>
